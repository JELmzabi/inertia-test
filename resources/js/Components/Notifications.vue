...
onMounted(async () => {
    ...
    var pusher = new Pusher('4587841df9337a243ee6', {
      cluster: 'mt1'
    });
...
<template>
    <Dropdown align="right" width="80">
        <template #trigger>
            <span class="inline-flex rounded-md" @click="hasNewNotification=false">
                <button type="button"
                    ...
                    <div class="w-2 h-2 bg-red-600 absolute right-3 top-2 rounded" v-if="hasNewNotification"></div>
                </button>
            </span>
        </template>
